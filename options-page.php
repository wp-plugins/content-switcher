...
<p style="margin: 1.5em"><a href="http://www.kleor-editions.com/<?php _e('content-switcher/en', 'content-switcher'); ?>"><?php _e('Documentation', 'content-switcher'); ?></a></p>
...
<a href="http://www.kleor-editions.com/<?php _e('content-switcher/en', 'content-switcher'); ?>/#tracking-id"><?php _e('More informations', 'content-switcher'); ?></a><br />
...
<a href="http://www.kleor-editions.com/<?php _e('content-switcher/en', 'content-switcher'); ?>/#tracking-id"><?php _e('More informations', 'content-switcher'); ?></a></p>
