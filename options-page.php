...
$content_switcher_options = array_map('htmlentities', $content_switcher_options); ?>
...
<form method="post" action="<?php echo htmlentities(htmlentities($_SERVER['REQUEST_URI'])); ?>">
